...
scheduler.set_xy = function (node, w, h, x, y) {
    ...
    if ($(node).attr('class') == "dhx_cal_data") {
        var rightH = parseInt(h) - 370;
        $('.ulWidgetBU').css('max-height', rightH.toString() + 'px');
    }
};
...
scheduler.form_blocks={
	...
	textarea:{
		render:function(sns){
			...
			return "<div class='dhx_cal_ltext' style='height:"+height+";'><textarea style=\"font-size:11px;\"></textarea></div>";
		},
